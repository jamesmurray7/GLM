...
b.minimise <- function(b, X, Y, lY, Z, W, delta, S, SS, Fi, Fu, l0i, l0u, Delta, 
  ...
  if(obj == 'joint_density'){
    if(method == 'optim'){
      b.hat <- mapply(function(b, X, Y, lY, Z, W, delta, S, SS, Fi, Fu, l0i, l0u, Delta, summax){
      ...
      }, b = b, X = X, Y = Y, lY = lY, Z = Z, W = W, delta = delta, S = S, SS = SS, Fi = Fi, Fu = Fu,
    ...
    if(Hessian == 'obj'){
      Sigma <- mapply(function(b, X, Y, lY, Z, W, delta, S, SS, Fi, Fu, l0i, l0u, Delta, summax){
        ...
        out
      }, b = b.hat, X = X, Y = Y, lY = lY, Z = Z, W = W, delta = delta, S = S, SS = SS, Fi = Fi, Fu = Fu,
      l0i = l0i, l0u = l0u, Delta = Delta, summax = summax, SIMPLIFY = F)
    }else{
      Sigma <- mapply(function(b, X, Y, lY, Z, W, delta, S, SS, Fi, Fu, l0i, l0u, Delta, summax){
