...
fits2b <- vector('list', 40)
pb <- utils::txtProgressBar(max = 40, style = 3)
for(i in 11:50){
  d <- tests[[i]]
...
save(fits2b, file = '/data/c0061461/no-grids_fits_b.RData')
